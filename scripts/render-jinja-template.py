...
def parse_args():
    parser = argparse.ArgumentParser(description='Parse a JSON and render it as Jinja template')
    parser.add_argument('--searchpath', default="templates",
                        help='The search path of Jinja2 templates.')
    parser.add_argument('--template', default="index.html",
                        help='The template to instanciate')
